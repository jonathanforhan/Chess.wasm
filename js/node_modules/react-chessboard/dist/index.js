        ...
        if ((arePremovesAllowed && isWaitingForAnimation) ||
            (arePremovesAllowed &&
                (lastPieceColour === piece[0] ||
                    premovesRef.current.filter((p) => p.piece[0] === piece[0]).length >
                        0))) {
...
function Notation({ row, col }) {
    ...
    function renderBottomLeft() {
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: whiteColor }), numericStyle(boardWidth)) }, { children: getRow() })), jsxRuntime.jsx("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: whiteColor }), alphaStyle(boardWidth)) }, { children: getColumn() }))] }));
    }
    function renderLetters() {
        return (jsxRuntime.jsx("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, { color: col % 2 !== 0 ? blackColor : whiteColor }), alphaStyle(boardWidth)) }, { children: getColumn() })));
    }
    function renderNumbers() {
        return (jsxRuntime.jsx("div", Object.assign({ style: Object.assign(Object.assign({ zIndex: 3, position: "absolute" }, (boardOrientation === "black"
...
function Piece({ isPremovedPiece = false, piece, square, squares, }) {
    const { animationDuration, arePiecesDraggable, arePremovesAllowed, boardWidth, id, isDraggablePiece, onPieceClick, onPieceDragBegin, onPieceDragEnd, premoves, chessPieces, positionDifferences, isWaitingForAnimation, currentPosition, } = useChessboard();
    ...
    return (jsxRuntime.jsx("div", Object.assign({ ref: arePiecesDraggable ? (canDrag ? drag : null) : null, onClick: () => onPieceClick(piece), "data-piece": piece, style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? (chessPieces[piece]({
            squareWidth: boardWidth / 8,
            isDragging,
        })) : (jsxRuntime.jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: boardWidth / 8, height: boardWidth / 8 }, { children: jsxRuntime.jsx("g", { children: chessPieces[piece] }) }))) })));
}

function Square({ square, squareColor, setSquares, squareHasPremove, children, }) {
    const squareRef = react.useRef(null);
    const { boardWidth, boardOrientation, clearArrows, currentPosition, customBoardStyle, customDarkSquareStyle, customDropSquareStyle, customLightSquareStyle, customPremoveDarkSquareStyle, customPremoveLightSquareStyle, customSquareStyles, handleSetPosition, lastPieceColour, onDragOverSquare, onMouseOutSquare, onMouseOverSquare, onPieceDrop, onRightClickDown, onRightClickUp, onSquareClick, isWaitingForAnimation, } = useChessboard();
    ...
    return (jsxRuntime.jsx("div", Object.assign({ ref: drop, style: defaultSquareStyle, "data-square-color": squareColor, "data-square": square, onMouseOver: (e) => {
            ...
            e.preventDefault();
        } }, { children: jsxRuntime.jsx("div", Object.assign({ ref: squareRef, style: Object.assign(Object.assign(Object.assign({}, size(boardWidth)), center), (!squareHasPremove && (customSquareStyles === null || customSquareStyles === void 0 ? void 0 : customSquareStyles[square]))) }, { children: children })) })));
}
const center = {
    display: "flex",
...
function Squares() {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ "data-boardid": id, style: Object.assign(Object.assign({}, boardStyles(boardWidth)), customBoardStyle) }, { children: [...Array(8)].map((_, r) => {
...
function Board() {
    ...
    const { arrows, boardOrientation, boardWidth, clearCurrentRightClickDown, customArrowColor, } = useChessboard();
    react.useEffect(() => {
    ...
    return boardWidth ? (jsxRuntime.jsxs("div", Object.assign({ ref: boardRef, style: { position: "relative" } }, { children: [jsxRuntime.jsx(Squares, {}), jsxRuntime.jsx("svg", Object.assign({ width: boardWidth, height: boardWidth, style: {
                    position: "absolute",
                    top: "0",
                    left: "0",
                    pointerEvents: "none",
                    ...
                    return (jsxRuntime.jsxs(react.Fragment, { children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsx("marker", Object.assign({ id: "arrowhead", markerWidth: "2", markerHeight: "2.5", refX: "1.25", refY: "1.25", orient: "auto" }, { children: jsxRuntime.jsx("polygon", { points: "0 0, 2 1.25, 0 2.5", style: { fill: customArrowColor } }) })) }), jsxRuntime.jsx("line", { x1: from.x, y1: from.y, x2: to.x, y2: to.y, style: {
                                    stroke: customArrowColor,
                                    strokeWidth: boardWidth / 36,
                                }, markerEnd: "url(#arrowhead)" })] }, `${arrow[0]}-${arrow[1]}`));
                }) }))] }))) : (jsxRuntime.jsx(WhiteKing, {}));
}
...
const Chessboard = react.forwardRef((props, ref) => {
    ...
    return backendSet && clientWindow ? (jsxRuntime.jsxs(ErrorBoundary, { children: [jsxRuntime.jsx("div", { ref: boardRef, style: { width: "100%" } }), jsxRuntime.jsx(DndProvider, Object.assign({ backend: backend, context: clientWindow, options: customDndBackend ? customDndBackendOptions : undefined }, { children: boardWidth && (jsxRuntime.jsxs(ChessboardProvider, Object.assign({ boardWidth: boardWidth }, otherProps, { ref: ref }, { children: [jsxRuntime.jsx(CustomDragLayer, {}), jsxRuntime.jsx(Board, {})] }))) }))] })) : null;
});
